...
int main(int argc, char** argv) {
	...
	if (PROG_OPT.verbose >= 0) {
	  ...
	  cout << "depth_or: " << PROG_OPT.depth_or << endl;
        ...
        DFS<KnapsackModel> d(s,o);
        while (KnapsackModel* current_solution = d.next()) {
            sols++;
            if (verbose >= 1)
